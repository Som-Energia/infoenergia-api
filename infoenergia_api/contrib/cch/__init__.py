...
class CurveRepository:
    ...
    async def get_curve(
        self, start, end, downloaded_from=None, downloaded_to=None, cups=None
    ):
        return await self.backend.get_curve(
            self, start, end, downloaded_from, downloaded_to, cups
        )
...
async def get_curve(
    curve_type, start, end, downloaded_from=None, downloaded_to=None, cups=None
):

...
class TestCchRequest:
    ...
    async def test__get_f5d_by_id__2A(self, app, auth_token, scenarios, mocked_next_cursor):
        params = {
            'from_': '2018-11-16',
            'to_': '2018-12-16',
            'limit': 10,
        ...
        assert response.json == {
            ...
            'next_page':'http://{}/cch/0067411?type=tg_cchfact&cursor=N2MxNjhhYmItZjc5Zi01MjM3LTlhMWYtZDRjNDQzY2ZhY2FkOk1RPT0=&limit=10'.format(response.url.netloc.decode()),
            'data': scenarios['f5d']['cch_data'],
        }

    async def test__get_f5d__all_contracts(self, app, auth_token, scenarios, mocked_next_cursor):
        ...
        assert response.json == {
             ...
             'cursor': mocked_next_cursor,
             'next_page':'http://{}/cch?type=tg_cchfact&cursor=N2MxNjhhYmItZjc5Zi01MjM3LTlhMWYtZDRjNDQzY2ZhY2FkOk1RPT0=&limit=50'.format(response.url.netloc.decode),
    ...
    async def test__get_p1__for_contract_id(self, app, auth_token, scenarios, mocked_next_cursor):
        ...
        assert response.json == {
            ...
            'cursor': mocked_next_cursor,
            'next_page':'http://{}/cch/0020309?type=P1&cursor=N2MxNjhhYmItZjc5Zi01MjM3LTlhMWYtZDRjNDQzY2ZhY2FkOk1RPT0=&limit=1'.format(response.url.netloc.decode),
        }

    async def test__get_p2__for_all_contracts(self, app, auth_token, scenarios, mocked_next_cursor):
        ...
        assert response.json == {
            ...
            'cursor': mocked_next_cursor,
            'next_page':'http://{}/cch?type=P2&cursor=N2MxNjhhYmItZjc5Zi01MjM3LTlhMWYtZDRjNDQzY2ZhY2FkOk1RPT0=&limit=1'.format(response.url.netloc.decode),

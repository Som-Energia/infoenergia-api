...
class TestBaseTariff(BaseTestCase):
    ...
    def test__get_tariff_2A(self):
        ...
        params = {"type": "2.0A", "from_": "2021-03-01", "to_": "2021-05-31"}
    ...
    def test__get_tariff__20TD_with_tariff_id(self):
        ...
        self.assertTrue(len(prices) > 0)
        self.assertTrue(tariffPriceId == 43)
...
class TestTariff(BaseTestCase):
    ...
    def test__get_erp_tariff_prices__date_range_20TD_OK(self):
        ...
        self.assertEqual(
            ...
            datetime.strptime(_prices["prices"]["history"][0]["dateEnd"], "%Y-%m-%d")
            + timedelta(days=1),
        )
        ...
        self.assertEqual(
            prices["prices"]["history"][0]["reactiveEnergy"],
            {
                "BOE núm. 76 - 30/03/2022": {
                    "0 - 0.80": {"unit": "€/kVArh", "value": 0.062332},
                    "0.80 - 0.95": {"unit": "€/kVArh", "value": 0.041554},
                }
            },
        )
